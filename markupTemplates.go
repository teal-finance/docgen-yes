...
// HTMLTemplate is a basic html page with placeholders for: {title}, {css}, {intro}, and {routes}
...
// HTMLUnorderedList is a list using bullet points instead of numbers
func HTMLUnorderedList(listItems string) string {
	return `
		<ul>
			` + listItems + `
		</ul>
...
// HTMLOrderedList is a numbered list
func HTMLOrderedList(listItems string) string {
	return `
		<ol>
			` + listItems + `
		</ol>
